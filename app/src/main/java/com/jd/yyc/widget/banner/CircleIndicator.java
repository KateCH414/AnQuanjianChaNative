...
public class CircleIndicator extends LinearLayout {
    ...
    public void setViewPager(ViewPager viewPager, int dataCount) {
    ...
    private final OnPageChangeListener mInternalPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            View selectedIndicator = getChildAt(position % mDataCount);
            if (selectedIndicator != null && mIndicatorBackgroundResId != 0) {
                selectedIndicator.setBackgroundResource(mIndicatorBackgroundResId);
                mAnimatorOut.setTarget(selectedIndicator);
                mAnimatorOut.start();
            }

            mLastPosition = position % mDataCount;
        }
    ...
    private DataSetObserver mInternalDataSetObserver = new DataSetObserver() {
        ...
        public void onChanged() {
            ...
            if (newCount == currentCount) {  // No change
                ...
                mLastPosition = mViewpager.getCurrentItem() % mDataCount;
            } else {
                mLastPosition = -1;
            }
    ...
    private void createIndicators() {
        ...
        int currentItem = mViewpager.getCurrentItem() % mDataCount;
